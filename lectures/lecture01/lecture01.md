...
| 10 мин | Часть (d) ноутбука: мультистарт; обсуждение 12.3. Затем открыть [`hw01.ipynb`](../../homeworks/hw01.ipynb), убедиться, что данные генерируются, и начать задачу 2(б). |
